...
if __name__ == "__main__":
    ...
    aruco_tracker = ArucoSingleTracker(id_to_find=31, marker_size=70, show_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
    
    print(aruco_tracker.track(verbose=True,loop=True))
