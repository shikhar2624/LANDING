...
class ArucoSingleTracker():
    ...
    def track(self, loop=True, verbose=False, show_video=None):
        ...
        while not self._kill:
            ...
            if not loop: return(marker_found, x_avg, y_avg, z)
...
if __name__ == "__main__":
    ...
    aruco_tracker = ArucoSingleTracker(id_to_find=31, marker_size=10, show_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
